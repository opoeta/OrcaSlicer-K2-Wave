...
//    def->min = 0;
    ...
    def->category = L("Strength");
    def->tooltip = L("This is an experimental feature that allows you to print staggered perimeters for better layer adhesion and strength.");
    def->mode    = comAdvanced;
    def->set_default_value(new ConfigOptionBool(false));
...
void PrintConfigDef::init_filament_option_keys()
{
    m_filament_option_keys = {
        ...
        "retract_before_wipe", "filament_retract_length_nc", "retract_after_wipe", "retract_restart_extra", "retraction_minimum_travel", "wipe", "wipe_distance",
