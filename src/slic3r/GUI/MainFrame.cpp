...
//    });
    ...
    append_menu_item(m_topbar->GetCalibMenu(), wxID_ANY, _L("Calibration Guide"), _L("Calibration Guide"), [this](wxCommandEvent &)
                     { wxLaunchDefaultBrowser("https://github.com/NanashiTheNameless/OrcaSlicer/wiki/calibration_guide", wxBROWSER_NEW_WINDOW); }, "", nullptr, [this]()
    ...
    append_menu_item(calib_menu, wxID_ANY, _L("Calibration Guide"), _L("Calibration Guide"),
        [this](wxCommandEvent&) { wxLaunchDefaultBrowser("https://github.com/NanashiTheNameless/OrcaSlicer/wiki/calibration_guide", wxBROWSER_NEW_WINDOW); }, "", nullptr,
        [this]() {return m_plater->is_view3D_shown();; }, this);
